...
<div class="card"><strong>Monitoring snapshot</strong>{{if .MonitoringStale}}stale{{else}}current{{end}}</div>
</section>
...
<footer>Use the authenticated CPA Management API for Check now and Test notification actions.</footer>
</main></body></html>`))
